                    ...
                    <div className="p-2 space-y-1">
                        ...
                        <div className="group flex items-center justify-between p-2 rounded-lg hover:bg-[#111] border border-transparent hover:border-gray-800 transition-all">
                            <div className="flex items-center gap-3">
                                {/* Checkbox */}
                                <div className="w-4 h-4 rounded-[4px] border border-orange-500 bg-orange-500/10 flex items-center justify-center cursor-pointer">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-1.5 bg-[#000] px-2 py-1 rounded-md border border-gray-800">
