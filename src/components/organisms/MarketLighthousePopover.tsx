    ...
    return (
        ...
        >
            ...
            <div className={cn(
                ...
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-[#14F195] via-[#FBA92E] to-[#FF4B4B] p-[1px]" />

                {/* Inner Content */}
                <div className="relative h-7 px-2 bg-[#0a0b0d] rounded-full flex items-center gap-2 m-[1px]">
